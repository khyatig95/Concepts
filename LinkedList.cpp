...
int main() {
    ...
    lis.insertNode(23);
    lis.insertNode(60);
    lis.insertNode(70);  //This will be new head
    lis.printLinkedList();
    lis.deleteNode(lis.head->next->next->next->next); //Try with head and tail
    lis.printLinkedList();
    lis.deleteNodewithVal(100); //Try with head and tail
    lis.printLinkedList();
    return 0;
}
